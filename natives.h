...
extern bool NETWORK_PLAYER_HAS_DIED_RECENTLY(int playerid);
extern void RESURRECT_NETWORK_PLAYER(int playerid, float x, float y, float z, float angle);
//END
...
extern void TASK_PLAY_ANIM(Ped ped, char *animName, char *animSet, float unknown0_8, bool loop, float unknown2_0, float unknown3_0, float unknown4_0, uint ms);
extern void TASK_PLAY_ANIM_SECONDARY_UPPER_BODY(Ped ped, char *animName, char *animSet, float unknown0_8, bool loop, float unknown2_0, float unknown3_0, float unknown4_0, uint ms);
//extern void TASK_PLAY_ANIM_FACIAL(Ped ped, ScriptAny, ScriptAny, ScriptAny, ScriptAny, ScriptAny, ScriptAny);
extern void TASK_PLAY_ANIM_FACIAL(Ped ped, char* animName, char* animSet, float time, uint unk1, uint unk2, uint unk3);
...
//extern void SET_VEHICLE_CAN_BE_TARGETTED_BY_HS_MISSILE(Vehicle veh, boolean set, float accuracy, boolean unknown0, boolean unknown1);
